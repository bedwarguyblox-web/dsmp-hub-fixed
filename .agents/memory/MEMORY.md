...
- [Listings atomic state transitions](listings-atomic.md) — buy/offer-accept/counter-accept use atomic_claim_listing(); partial UNIQUE index + IntegrityError for dedupe; persist DM tokens only after send succeeds.
